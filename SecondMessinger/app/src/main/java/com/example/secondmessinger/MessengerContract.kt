package com.example.secondmessinger
...
class MessengerContract {
    ...
    companion object {
        private const val SERVICE_PACKAGE_NAME = "com.example.firstmessinger"
        private const val SERVICE_CLASS_NAME = "$SERVICE_PACKAGE_NAME.MessengerService"
        ...
        companion object {
            ...
            fun parseRequestMessagePayload(payload: Bundle?): String {
                if (payload != null && payload.containsKey(PAYLOAD_KEY_MESSAGE)) {
                    return payload.getString(PAYLOAD_KEY_MESSAGE)!!
                } else {
        ...
        companion object {
            ...
            fun parseResponseMessagePayload(payload: Bundle?): Int {
                if(payload != null && payload.containsKey(PAYLOAD_KEY_NUMBERS_ADDITION_RESULT)) {
                    return payload.getInt(PAYLOAD_KEY_NUMBERS_ADDITION_RESULT)
                } else {
